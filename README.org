...
**** Vanilla Emacs
     ...
     - install [[https://github.com/emacs-lsp/helm-lsp][helm-lsp]] provides on type completion alternative of =xref-apropos= using =helm=.
     - install [[https://github.com/emacs-lsp/lsp-ivy][lsp-ivy]] provides on type completion alternative of =xref-apropos= using =ivy=.
...
**** Docker
     Refer to [[https://github.com/emacs-lsp/lsp-docker/][lsp-docker]] README which provides a guide on how you can run =lsp-mode= in =docker= container.
*** Performance
    ...
    optimal results.
    - Use Emacs 27+ with native json support. (Note: this requires that you have
      [libjansson](http://www.digip.org/jansson/) installed, and that emacs was 
      compiled with `--with-json` passed to ./configure.) You can check your 
      installation for native JSON support by running do 
      =M-: (functionp 'json-serialize) RET=. Benchmarks
...
** Supported languages
   ...
   | Dart                  | [[https://github.com/dart-lang/sdk/blob/master/pkg/analysis_server/tool/lsp_spec/README.md][dart_analysis_server]]                      | [[https://github.com/emacs-lsp/lsp-dart][lsp-dart]]      | built into dart-sdk                                                                                     | Yes                          |
